...
const SignUp = () => {
  ...
  return (
    <div className='sign-up-main '>
      <div className='sign-up container-sm gap-5 d-flex position-relative '>
        <div className='sign-up-frame-1 bg-primary border border-primary d-none d-lg-flex align-items-center w-50'>
          <div className='container d-flex flex-column justify-content-center align-items-center gap-5 p-1 '>
            ...
            <img className='img-vector img-fluid mb-5 signup-vector position-absolute ' src={signupVector} alt='' />
          </div>
        </div>

        <div className='sign-up-section d-sm-flex  p-5 rounded-3 align-items-center'>
