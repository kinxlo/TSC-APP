...
const JobPosting = () => {
  ...
  const [showApplicationDeadlineDropdownTwo, setShowApplicationDeadlineDropdownTwo] = useState(false)
  ...
  const handleDropdownToggleTwo = (dropdownType) => {
    if (dropdownType === 'payRange') {
      ...
      setShowApplicationDeadlineDropdownTwo(!showApplicationDeadlineDropdownTwo)
  ...
  const handleButtonClick = (buttonText, inputName) => {
    if (inputName === 'addSkills') {
      setSelectedSkillButtons((prevButtons) => (prevButtons.includes(buttonText) ? prevButtons : [...prevButtons, buttonText]))
    } else if (inputName === 'addTools') {
      setSelectedToolButtons((prevButtons) => (prevButtons.includes(buttonText) ? prevButtons : [...prevButtons, buttonText]))
    }
  }

  const handleImageClick = (inputName) => {
    const selectedButtons = inputName === 'addSkills' ? selectedSkillButtons : selectedToolButtons
      ...
      <form className='bigf' onSubmit={handleSubmitFill}>
          ...
          <div>
            ...
            <div className='inner-3'>
              ...
              <div
                className='in-img1'
                style={{
                  transform: showJobTypeDropdown ? 'rotate(180deg)' : 'rotate(0deg)',
                }}
                onClick={() => handleDropdownToggle('jobType')}
              >
              ...
              {showJobTypeDropdown && (
                <div className='dropdown'>
                  <div onClick={() => handleDropdownSelect('Web Development', 'jobType')}>
                    <p className='m-0'>Web Development</p>
                  </div>
                  <div onClick={() => handleDropdownSelect('Product Design', 'jobType')}>
                    <p className='m-0'>Product Design</p>
                  </div>
                  <div onClick={() => handleDropdownSelect('Data Analysis', 'jobType')}>
          ...
          <div>
            ...
            <div className='inner-4'>
              ...
              <div
                className='in-img2'
                style={{
                  transform: showExperienceLevelDropdown ? 'rotate(180deg)' : 'rotate(0deg)',
                }}
                onClick={() => handleDropdownToggle('experienceLevel')}
              >
                <img src='../../../src/assets/Vectordrop.png' alt='arrowd' />
              ...
              {showExperienceLevelDropdown && (
                <div className='dropdown'>
                  <div onClick={() => handleDropdownSelect('4-6 Months', 'experienceLevel')}>
                    <p className='m-0'>4-6 Months</p>
                  </div>
                  <div onClick={() => handleDropdownSelect('1-2 years', 'experienceLevel')}>
                    <p className='m-0'>1-2 years</p>
                  </div>
                  <div onClick={() => handleDropdownSelect('2-3 years', 'experienceLevel')}>
                    <p className='m-0'>2-3 years</p>
                  </div>
                  <div onClick={() => handleDropdownSelect('3-4 years ', 'experienceLevel')}>
                    <p className='m-0'>3-4 years</p>
                  </div>
                  <div onClick={() => handleDropdownSelect('4-5 years', 'experienceLevel')}>
        ...
        <div className='fill-5'>
          <div className='inner-5'>
            <p className='m-0 skills'>What skills or languages are you looking to hire?</p>
            <div className='in-img5' onClick={() => handleImageClick('addSkills')}>
              <input className='in-5' type='text' name='addSkills' value={formDataFill.addSkills} onChange={handleChangeFill} placeholder='Add new skill' />
            ...
            <div className='bot-5'>
              <div className='b-1'>
                <button
                  className={`m-0 ${selectedSkillButtons.includes('UI/UX Design') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('UI/UX Design', 'addSkills')}
                >
                  UI/UX Design
                </button>
                <button
                  className={`m-0 ${selectedSkillButtons.includes('Android Development') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('Android Development', 'addSkills')}
                >
                  Android Development
                </button>
              </div>
              <div className='b-2'>
                <button
                  className={`m-0 ${selectedSkillButtons.includes('Front End Development') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('Front End Development', 'addSkills')}
                >
                  Front End Development
                </button>
                <button
                  className={`m-0 ${selectedSkillButtons.includes('Back End Development') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('Back End Development', 'addSkills')}
                >
          ...
          <div className='inner-6'>
            ...
            <div className='in-img6' onClick={() => handleImageClick('addTools')}>
              <input className='in-6' type='text' name='addTools' value={formDataFill.addTools} onChange={handleChangeFill} placeholder='Add new tool' />
            ...
            <div className='bot-6'>
              <div className='b-3'>
                <button className={`m-0 ${selectedToolButtons.includes('Figma') ? 'selected' : ''}`} onClick={() => handleButtonClick('Figma', 'addTools')}>
                  Figma
                </button>
                <button
                  className={`m-0 ${selectedToolButtons.includes('Adobe XD') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('Adobe XD', 'addTools')}
                >
                  Adobe XD
                </button>
                <button
                  className={`m-0 ${selectedToolButtons.includes('Invision') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('Invision', 'addTools')}
                >
                  Invision
                </button>
                <button
                  className={`m-0 ${selectedToolButtons.includes('Cinema 3D') ? 'selected' : ''}`}
              ...
              <div className='b-4'>
                <button
                  className={`m-0 ${selectedToolButtons.includes('Illustrator') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('Illustrator', 'addTools')}
                >
                  Illustrator
                </button>
                <button
                  className={`m-0 ${selectedToolButtons.includes('Corel Draw') ? 'selected' : ''}`}
                  onClick={() => handleButtonClick('Corel Draw', 'addTools')}
                >
                  Corel Draw
                </button>
                <button
                  className={`m-0 ${selectedToolButtons.includes('Photoshop') ? 'selected' : ''}`}
          ...
          <div>
            ...
            <div className='inner-7'>
              ...
              <div
                className='in-img7'
                style={{
                  transform: showPayRangeDropdownTwo ? 'rotate(180deg)' : 'rotate(0deg)',
                }}
                onClick={() => handleDropdownToggleTwo('payRange')}
              >
                <img src='../../../src/assets/Vectordrop.png' alt='arrowd' />
              ...
              {showPayRangeDropdownTwo && (
                <div className='dropdown'>
                  <div onClick={() => handleDropdownSelectTwo('N150,000-250,000', 'payRange')}>
                    <p className='m-0'>N150,000-250,000</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('N250,000-350,000', 'payRange')}>
                    <p className='m-0'>N250,000-350,000</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('N350,000-450,000', 'payRange')}>
                    <p className='m-0'>N350,000-450,000</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('N350,000-450,000', 'payRange')}>
                    <p className='m-0'>N350,000-450,000</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('N650,000-750,000', 'payRange')}>
          ...
          <div>
            ...
            <div className='inner-8'>
              ...
              <div
                className='in-img8'
                style={{
                  transform: showApplicationDeadlineDropdownTwo ? 'rotate(180deg)' : 'rotate(0deg)',
                }}
                onClick={() => handleDropdownToggleTwo('applicationDeadline')}
              >
                <img src='../../../src/assets/Vectordrop.png' alt='arrowd' />
              ...
              {showApplicationDeadlineDropdownTwo && (
                <div className='dropdown'>
                  <div onClick={() => handleDropdownSelectTwo('2-3 Weeks', 'applicationDeadline')}>
                    <p className='m-0'>2-3 Weeks</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('1 Month', 'applicationDeadline')}>
                    <p className='m-0'>1 Month</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('2 Months', 'applicationDeadline')}>
                    <p className='m-0'>2 Months</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('3 Months', 'applicationDeadline')}>
                    <p className='m-0'>3 Months</p>
                  </div>
                  <div onClick={() => handleDropdownSelectTwo('4 Months', 'applicationDeadline')}>
